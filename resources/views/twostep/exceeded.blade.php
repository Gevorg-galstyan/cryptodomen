...
@section('title')
    {{ trans('laravel-verification.exceededTitle') }}
@endsection
            ...
            <div class="panel panel verification-exceeded-panel">
                ...
                <div class="panel-body">
                    <h4 class="text-center text-danger">
                        <em>
                            {{ trans('laravel-verification.lockedUntil') }}
                        </em>
                        <br />
                        <strong>
                            {{ $timeUntilUnlock }}
                        ...
                        <br />
                        <small>
                            {{ trans('laravel-verification.tryAgainIn') }} {{ $timeCountdownUnlock }} &hellip;
                        </small>
                    </h4>
                    <p class="text-center">
                        <a class="btn btn-info" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" tabindex="6">
                            <i class="glyphicon glyphicon-home" aria-hidden="true"></i> {{ trans('laravel-verification.returnButton') }}
                        </a>
