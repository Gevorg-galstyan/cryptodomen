...
@section('title')
    {{ trans('laravel-verification.titlePhone') }}
@endsection
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel verification-form-panel">
                        <div class="panel-heading text-center" id="verification_status_title">
                            ...
                            <p class="text-center">
                                <em>
                                    {{ trans('laravel-verification.subtitle') }}
                                </em>
                            </p>
                        </div>
                                    ...
                                    <div class="col-xs-3">
                                        <div class="{{ $errors->has('v_input_1') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" id="v_input_1" class="form-control text-center required"
                                                   required name="v_input_1" value="" autofocus maxlength="1"
                                                   minlength="1" tabindex="1" placeholder="•">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 text-center">
                                            <p class="text-{{ $remainingAttemptsClass }}">
                                                <small>
                                                    <span
                                                            id="remaining_attempts">{{ $remainingAttempts }}</span> {{ trans_choice('laravel-verification.attemptsRemaining', $remainingAttempts) }}
                                                </small>
                                            </p>
                                        </div>
                                        <div class="col-xs-12 text-center">
...
@section('js')
    ...
    @include('scripts.input-parsing-auto-stepper');
    ...
    <script type="text/javascript">
        ...
        $("#resend_code_trigger").click(function (event) {
            ...
            var resultStatus;
            var resultData;
            var endpoint = "{{route('resendPhoneCode')}}";
