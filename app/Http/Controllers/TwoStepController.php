...
class TwoStepController extends Controller
{
    ...
    {
        $user                       = Auth::User();
        $twoStepAuth                = $this->getTwoStepAuthStatus($user->id, 'email');
    ...
    public function showVerification()
    {
        ...
        return View('twostep.verification')->with($data);
    }
    ...
    public function resend()
    {
        ...
        $twoStepAuth = $this->_twoStepAuth;
        $this->sendVerificationCodeNotification($twoStepAuth, 'email');

        $returnData = [
            'title' => trans('laravel-verification.verificationEmailSuccess'),
            'message' => trans('laravel-verification.verificationEmailSentMsg'),
        ];
